<div align="center">
    <p>Serving over 4.3 people sience 200 BCE<p>
    <p>SigmaRzzler is a web proxy with a Clean and Sleek UI and easy to use menus. Our goal is to provide the best user experience to everyone.</p>
</div>
...
**Join Our [Discord Community]((https://discord.gg/RaGzwGF2)) for support, more links, and an active community!**
...
For more deployment options, join our [Discord Server]((https://discord.gg/RaGzwGF2)) for various ways to deploy Interstellar.
...
> [!TIP]
> If you're having trouble, don't hesitate to reach out to us on [Discord](https://discord.gg/RaGzwGF2) for personalized support.
# Credits

A huge thanks goes out to all of the 2.62 people who have contributed to SigmaRizzler
